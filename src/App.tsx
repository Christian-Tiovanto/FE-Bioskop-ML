...
const initialMoviesData = [
  {
    ...
    title: "Galaxy Quest",
    cover_img_url:
      "https://placehold.co/500x750/1a202c/ffffff?text=Galaxy+Quest",
    synopsis:
  ...
  },
  {
    ...
    cover_img_url:
      "https://placehold.co/500x750/4a5568/ffffff?text=The+Last+Alchemist",
    synopsis:
  ...
  },
  {
    ...
    cover_img_url:
      "https://placehold.co/500x750/718096/ffffff?text=Ocean's+Whisper",
    synopsis:
    ...
    comments: [
      {
        ...
        is_good: true,
        created_at: "2024-08-11T11:20:00Z",
      },
    ],
  },
  {
    ...
    title: "Zero Gravity",
    cover_img_url:
      "https://placehold.co/500x750/a0aec0/000000?text=Zero+Gravity",
    synopsis:
  ...
  },
  {
    ...
    cover_img_url:
      "https://placehold.co/500x750/cbd5e0/000000?text=Forgotten+Echoes",
    synopsis:
...
const MovieDetail = ({ movie, onDeselectMovie, onAddComment }) => {
...
function App() {
  ...
  const handleAddComment = (movieId, newComment) => {
